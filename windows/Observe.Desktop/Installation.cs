...
public sealed class InstallReceipt
{
    ...
    public string Version {get;set;}="0.12.1-beta-vibe-coded";
...
public static class Installation
{
    ...
    public static async Task Install(InstallSelection selection)
    {
        ...
        {
            key.SetValue("DisplayName","Observe");key.SetValue("DisplayVersion","0.12.1-beta-vibe-coded");key.SetValue("Publisher","Observe open source");key.SetValue("InstallLocation",InstallRoot);key.SetValue("DisplayIcon",executable);
